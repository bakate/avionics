...
/**
 * HTTP implementation of the CurrencyConverterGateway.
 */
export const HttpCurrencyConverterGatewayLive = Layer.scoped(
  CurrencyConverterGateway,
  Effect.gen(function* () {
 ...
 */
export const HttpCurrencyConverterGatewayTest = (
  overrides: Partial<CurrencyConverterGateway> = {},
) =>
  Layer.succeed(
    CurrencyConverterGateway,
