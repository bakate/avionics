...
**Property 5: All unpublished events are fetched** ✅
...
**Property 6: Published events have timestamps** ✅
...
**Property 7: Retry logic increments retry count on failure** ✅
...
**Property 8: Events with max retries are skipped** ✅
...
**Property 9: Booking queries don't load full aggregates**✅
...
**Property 10: Inventory queries don't trigger domain logic**✅
...
**Property 11: Query failures return typed errors**✅
...
**Property 12: findAvailableFlights respects cabin and minSeats filter** ✅
...
**Property 13: Payment requests include authentication** ✅
...
**Property 14: Successful payments return transaction IDs** ✅
...
**Property 15: Payment API errors map to domain errors** ✅
...
**Property 16: All payment attempts are logged** ✅
...
**Property 17: Notification requests include authentication** ✅
...
**Property 18: Successful sends return message IDs** ✅
...
**Property 19: Notification API errors map to domain errors** ✅
...
**Property 20: Tickets are formatted in emails** ✅
...
**Property 21: Aggregate saves create audit records** ✅
...
**Property 22: User context is captured when available** ✅
...
**Property 23: Audit records have timestamps** ✅
...
**Property 24: Missing required config fails fast** ✅
...
**Property 25: Optional config uses defaults** ✅
...
**Property 26: Sensitive values are redacted in logs** ✅
...
**Property 27: Health checks verify database** ✅
...
**Property 28: Health checks verify outbox processor** ✅
...
**Property 29: Unhealthy services return unhealthy status** ✅
...
**Property 30: Health responses include version** ✅
...
**Property 31: Shutdown closes database connections** ✅
...
**Property 32: Constraint violations map to domain errors** ✅
...
**Property 33: Network timeouts return typed errors** ✅
...
**Property 34: External API errors map to domain errors** ✅
...
**Property 35: Errors preserve stack traces** ✅
...
**Property 36: Error messages don't expose internals** ✅
...
**Property 37: Unexpected status codes map to ExternalServiceUnexpectedStatusError** ✅
...
| 5-8        | ✅ Implemented | `test/unit/events/outbox-processor.property.test.ts`                                                          |
| 9          | ✅ Implemented | `test/unit/queries/booking-queries.property.test.ts`                                                          |
| 10         | ✅ Implemented | `test/unit/queries/inventory-queries.property.test.ts`                                                        |
| 11         | ✅ Implemented | `test/unit/queries/booking-queries.property.test.ts` & `test/unit/queries/inventory-queries.property.test.ts` |
| 12         | ✅ Implemented | `test/unit/queries/booking-queries.property.test.ts` & `test/unit/queries/inventory-queries.property.test.ts` |
| 13-16      | ✅ Implemented | `test/unit/gateways/payment-gateway.property.test.ts`                                                         |
| 17-20      | ✅ Implemented | `test/unit/gateways/notification-gateway.property.test.ts`                                                    |
| 21-23      | ✅ Implemented | `test/unit/services/audit-logger.property.test.ts`                                                            |
| 24-26      | ✅ Implemented | `config/infrastructure-config.property.test.ts`                                                               |
| 27-30      | ✅ Implemented | `test/unit/services/health-check.property.test.ts`                                                            |
| 31         | ✅ Implemented | `test/unit/services/shutdown-manager.property.test.ts`                                                        |
| 32-36      | ✅ Implemented | `errors/error-mapper.property.test.ts`                                                                        |
| 37         | ✅ Implemented | `test/unit/gateways/notification-gateway.property.test.ts`                                                    |
...
- Example: Property 9 (queries don't load aggregates)
...
- Example: Property 6 (published events stay published)
...
- Example: Property 12 (pagination respects parameters)
